...
''',
      variables: [
        ...
        if (farmerProject != null) Variable.withString(farmerProject) else const Variable(null),
...
''',
      variables: [
        ...
        if (lastErrorCode != null) Variable.withString(lastErrorCode) else const Variable(null),
        if (serverResponseJson != null) Variable.withString(serverResponseJson) else const Variable(null),
        if (serverRequestId != null) Variable.withString(serverRequestId) else const Variable(null),
...
''',
      variables: [
        Variable.withString(clientMutationId),
        Variable.withString(entity),
        if (serverName != null) Variable.withString(serverName) else const Variable(null),
...
''',
      variables: [
        ...
        if (errorCode != null) Variable.withString(errorCode) else const Variable(null),
        if (requestId != null) Variable.withString(requestId) else const Variable(null),
        if (rawResponseJson != null) Variable.withString(rawResponseJson) else const Variable(null),
        Variable.withString(startedAt.toUtc().toIso8601String()),
        if (finishedAt != null) Variable.withString(finishedAt.toUtc().toIso8601String()) else const Variable(null),
      ],
      updates: {},
    );
  }
...
''',
      variables: [
        ...
        if (block != null) Variable.withString(block) else const Variable(null),
        if (sortKey != null) Variable.withString(sortKey) else const Variable(null),
        Variable.withString(payloadJson),
