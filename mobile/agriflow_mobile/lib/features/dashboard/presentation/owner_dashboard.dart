...
import 'package:agriflow_mobile/features/profit/presentation/profit_dashboard_screen.dart';
    ...
    return ListView(
      ...
      children: [
        ...
        const SizedBox(height: 8),
          ...
          Card(
            child: ListTile(
              leading: Icon(Icons.dashboard, color: Colors.deepPurple.shade700),
              title: const Text('Profit Dashboard / லாப டாஷ்போர்டு'),
              subtitle: const Text('Sales + project insights'),
              trailing: const Icon(Icons.chevron_right),
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (_) => const ProfitDashboardScreen(),
                  ),
                );
              },
            ),
